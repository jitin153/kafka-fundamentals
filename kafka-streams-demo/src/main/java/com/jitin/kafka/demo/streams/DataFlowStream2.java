 ...
 * 2. streams-dataflow-output
 * 		Command: kafka-topics --create --zookeeper localhost:2181 --replication-factor 1 --partitions 1 --topic streams-dataflow-output
...
public class DataFlowStream2 {
	...
	public static void main(String[] args) {
		...
		stream.filter((key, value) -> value.contains("token"))
				...
				// After processing, writing the stream to the other topic.
